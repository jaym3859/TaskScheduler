...
//  2019-04-30: OpenGL: Added support for special ImDrawCallback_ResetRenderState callback to reset draw state.
//  2019-03-29: OpenGL: Not calling glBindBuffer more than necessary in the draw loop.
...
//  2018-02-23: OpenGL: Create the VAO in the draw function so the setup can more easily be used with multiple shared GL context.
...
static void ImGui_ImplOpenGL3_SetupRenderState(ImDrawData* draw_data, int fb_width, int fb_height, GLuint vertex_array_object)
{
    ...
    // Setup draw state: alpha-blending enabled, no face culling, no depth testing, scissor enabled, polygon fill
    glEnable(GL_BLEND);
    ...
    for (int n = 0; n < draw_data->CmdListsCount; n++)
    {
        ...
        for (int cmd_i = 0; cmd_i < draw_list->CmdBuffer.Size; cmd_i++)
        {
            ...
            if (pcmd->UserCallback != nullptr)
            {
                ...
                // (ImDrawCallback_ResetRenderState is a special callback value used by the user to request the renderer to reset draw state.)
